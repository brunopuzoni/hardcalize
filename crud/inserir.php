...
$resultado = mysql_query("INSERT INTO usuario (login_us, senha_us, nome_us, email_us, cidade_us, estado_us, telefone_us) VALUES ('$_REQUEST[login_us]', '$_REQUEST[senha_us]', '$_REQUEST[nome_us]', '$_REQUEST[email_us]', '$_REQUEST[cidade_us]', '$_REQUEST[estado_us]', '$_REQUEST[telefone_us]')") or die ("Erro...");
mysql_close($conexao);
