...
<html lang="pt-BR">
   <head>
      ...
      <title>Sobre a Equipe - Hardcalize</title>
   ...
   ?>
      ...
      <section>
         ...
         <div id="content">
            <div class="line">
               <p class="s-12 m-12 l-8 center">A equipe é formada de alunos do terceiro ano do ensino médio, da escola ETEC Professora Maria Cristina Medeiros, da cidade de Ribeirão Pires, em São Paulo. O projeto foi desenvolvido pela turma do ensino médio integrado com o ensino técnico em Informática para Internet como um Trabalho de Conclusão de Curso no ano de 2017. 
               </p>
            </div>
         </div>
         ...
         <div id="third-block">
            <div class="line">
			   ...
			   <br>
               <div class="margin">
                  <div class="s-12 m-12 l-5 l-offset-1">
                     <img src="img/equipe/Bruno.jpg" width="720" height="720">      
                     <p class="subtitile">Bruno Puzoni
                     </p>
                  </div>
                  <div class="s-12 m-6 l-5">
                     <img src="img/equipe/Giacomo.jpg" width="720" height="720">      
                     <p class="subtitile">Giácomo Fernandez
                     </p>
                  </div>
                  <div class="s-12 m-6 l-4">
                     <img src="img/equipe/Samuel.jpg">      
                     <p class="subtitile">Samuel Bertoni
                     </p>
                  </div>
                  <div class="s-12 m-6 l-4">
                     <img src="img/equipe/Gabriel.jpg">      
                     <p class="subtitile">Gabriel Henrique
                     </p>
                  </div>
                  <div class="s-12 m-6 l-4">
                     <img src="img/equipe/Daniel.jpg">      
                     <p class="subtitile">Daniel Borges
                     </p>
                  </div>
               </div>
            </div>
