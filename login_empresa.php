...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $myusername = mysqli_real_escape_string($db,$_POST['login_empresa']);
      $mypassword = mysqli_real_escape_string($db,$_POST['senha_empresa']); 
      
	
      $sql = "SELECT id_empresa FROM empresa WHERE login_empresa = '$myusername' and senha_empresa = '$mypassword'";
      ...
      if($count == 1)
	  {
        //session_register("myusername");
			...
			$_SESSION['login_empresa'] = $row['id_empresa'];
...
?>
               ...
               <p class="s-8 m-4 l-3 center"><input type="text" placeholder="Login" id="login" name="login_empresa">
               </p>
               <p class="s-8 m-4 l-3 center"><input type="password" placeholder="Senha" id="senha" name="senha_empresa">
               </p>
