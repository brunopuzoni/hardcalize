   ...
   ?>
      ...
      <section>
         <div id="head">
            <div class="line">
               <h1>Parkour</h1>
               <a class="button s-12 l-2 center" href="../esportes/parkour.php">Descrição do Esporte</a>
            </div>
         </div>
           <div id="content">
            <div class="line">
               <div class="margin">
              <?php
			  $resultado = mysqli_query($db,"SELECT nome_lugar,cidade_lugar,estado_lugar,site_lugar,id_lugar,imagem FROM lugar WHERE id_esporte=10");
			  mysqli_close($db);
